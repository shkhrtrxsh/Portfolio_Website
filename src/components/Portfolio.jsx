...
const Portfolio = () => {
  ...
  return (
    <div
      name="portfolio"
      className="pb-32 pt-32 bg-gradient-to-b from-black to-gray-800 w-full text-white md:h-screen"
    >
          ...
          {portfolios.map(({ id, src, href, code, desc }) => (
            <div key={id} className="shadow-md shadow-gray-600 rounded-lg">
              ...
              <div className="flex items-center justify-center">
                <a href={href} target="_blank" className="hover:cursor-pointer w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105">
                  Demo
                </a>
